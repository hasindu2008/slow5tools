...
### s2f [I would prefer slow2fast]

`slow5tools slow2fast [OPTIONS] file1.blow5 -o fast5_dir`

`slow5tools slow2fast [OPTIONS] blow5_dir1 -o fast5_dir`

`slow5tools slow2fast [OPTIONS] file1.blow5 file2.blow5 ... -o fast5_dir`

`slow5tools slow2fast [OPTIONS] blow5_dir1 blow5_dir2 ... -o fast5_dir`
...
Generates summary statistics describing a SLOW5/BLOW5 file.
