...
echo
if ! $SLOW5_EXEC merge $SLOW5_DIR -o $MERGE_atm1_OUTPUT/merged1.slow5 -t 16 -s; then
...
echo
if ! $SLOW5_EXEC merge $SPLIT_OUTPUT/read_split -o $MERGE_atm2_OUTPUT/merged2.slow5 -t 16 -s; then
