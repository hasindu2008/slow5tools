...
int slow5_to_blow5_zlib(void) {
    ...
    FILE *to = fopen("test/data/out/one_fast5/slow5_to_blow5_zlib.blow5", "w");
    ASSERT(to != NULL);

    /*
    ASSERT(slow5_hdr_fwrite(to, from->header, FORMAT_BINARY, COMPRESS_zlib) != -1);

    struct slow5_rec *read = NULL;
    int ret;
    struct press *zlib = press_init(COMPRESS_zlib);
    ASSERT(zlib != NULL);
    while ((ret = slow5_get_next(&read, from)) == 0) {
        ASSERT(slow5_rec_fwrite(to, read, FORMAT_BINARY, zlib) != -1);
    }
    slow5_rec_free(read);
    ASSERT(ret == -2);
    ...
    press_free(zlib);
    */
    ASSERT(slow5_convert(from, to, FORMAT_BINARY, COMPRESS_zlib) == 0)
...
int blow5_zlib_to_slow5(void) {
    struct slow5_file *from = slow5_open("test/data/exp/one_fast5/exp_1_default_zlib.blow5", "r");
    ASSERT(from != NULL);

    FILE *to = fopen("test/data/out/one_fast5/blow5_zlib_to_slow5.slow5", "w");
    ASSERT(to != NULL);
...
int blow5_zlib_to_blow5_uncomp(void) {
    ...
    FILE *to = fopen("test/data/out/one_fast5/blow5_zlib_to_blow5_uncomp.blow5", "w");
    ASSERT(to != NULL);
...
int blow5_uncomp_to_blow5_zlib(void) {
    ...
    FILE *to = fopen("test/data/out/one_fast5/blow5_uncomp_to_blow5_zlib.blow5", "w");
    ASSERT(to != NULL);
...
int slow5_to_blow5_zlib_lossless(void) {
    ...
    FILE *to = fopen("test/data/out/one_fast5/slow5_to_blow5_zlib_lossless.blow5", "w");
    ASSERT(to != NULL);
...
int blow5_zlib_to_slow5_lossless(void) {
    struct slow5_file *from = slow5_open("test/data/exp/one_fast5/exp_1_lossless_zlib.blow5", "r");
    ASSERT(from != NULL);

    FILE *to = fopen("test/data/out/one_fast5/blow5_zlib_to_slow5_lossless.slow5", "w");
    ASSERT(to != NULL);
...
int blow5_zlib_to_blow5_uncomp_lossless(void) {
    ...
    FILE *to = fopen("test/data/out/one_fast5/blow5_zlib_to_blow5_uncomp_lossless.blow5", "w");
    ASSERT(to != NULL);
...
int blow5_uncomp_to_blow5_zlib_lossless(void) {
    ...
    FILE *to = fopen("test/data/out/one_fast5/blow5_uncomp_to_blow5_zlib_lossless.blow5", "w");
    ASSERT(to != NULL);
...
int slow5_to_blow5_zlib_lossless_aux_array(void) {
    ...
    FILE *to = fopen("test/data/out/aux_array/slow5_to_blow5_zlib_lossless.blow5", "w");
    ASSERT(to != NULL);
...
int blow5_zlib_to_slow5_lossless_aux_array(void) {
    struct slow5_file *from = slow5_open("test/data/exp/aux_array/exp_lossless_zlib.blow5", "r");
    ASSERT(from != NULL);

    FILE *to = fopen("test/data/out/aux_array/blow5_zlib_to_slow5_lossless.slow5", "w");
    ASSERT(to != NULL);
...
int blow5_zlib_to_blow5_uncomp_lossless_aux_array(void) {
    ...
    FILE *to = fopen("test/data/out/aux_array/blow5_zlib_to_blow5_uncomp_lossless.blow5", "w");
    ASSERT(to != NULL);
...
int blow5_uncomp_to_blow5_zlib_lossless_aux_array(void) {
    ...
    FILE *to = fopen("test/data/out/aux_array/blow5_uncomp_to_blow5_zlib_lossless.blow5", "w");
    ASSERT(to != NULL);
