...
if g++ -Wall -g test/unit_test_helpers.c -o test/bin/unit_test_helpers src/slow5.c src/misc.c src/slow5idx.c src/press.c -I src/ -lz; then
...
if g++ -Wall -g test/unit_test_press.c -o test/bin/unit_test_press src/press.c -I src/ -lz; then
...
if g++ -Wall -g test/unit_test_ascii.c -o test/bin/unit_test_ascii src/slow5.c src/misc.c src/slow5idx.c src/press.c -I src/ -lz; then
...
if g++ -Wall -g test/unit_test_binary.c -o test/bin/unit_test_binary src/slow5.c src/misc.c src/slow5idx.c src/press.c -I src/ -lz; then
...
if g++ -Wall -g test/convert_slow5_test.c -o test/bin/convert_slow5_test src/slow5.c src/misc.c src/slow5idx.c src/press.c -I src/ -lz; then
...
if g++ -Wall -g test/unit_test_two_rg.c -o test/bin/unit_test_two_rg src/slow5.c src/misc.c src/slow5idx.c src/press.c -I src/ -lz; then
...
if g++ -Wall -g test/unit_test_loseless.c -o test/bin/unit_test_loseless src/slow5.c src/misc.c src/slow5idx.c src/press.c -I src/ -lz; then
