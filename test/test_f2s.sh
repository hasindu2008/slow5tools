...
slow5tools_quickcheck() {
    ...
    if [ $? -eq 0 ]; then
        info "${GREEN}SUCCESS: slow5tools_quickcheck passed!"
    elif [ $? -eq 1 ]; then
        info "${RED}FAILURE: $PWD/${1} files are corrupted"
        exit 1
    else
        info "${RED}ERROR: slow5tools_quickcheck failed for some weird reason"
        exit 1
    fi
}

TESTCASE_NO=1
info "------------------- f2s testcase $TESTCASE_NO: format:single-fast5 input:file process:single_process output:stdout-------------------"
...
info "testcase $TESTCASE_NO passed"

TESTCASE_NO=2
info "------------------- f2s testcase $TESTCASE_NO: format:single-fast5 input:file process:single_process output:directory-------------------"
...
TESTCASE_NO=3
info "------------------- f2s testcase $TESTCASE_NO: format:single-fast5 input:directory process:single_process output:stdout-------------------"
...
TESTCASE_NO=4
info "------------------- f2s testcase $TESTCASE_NO: format:single-fast5 input:directory process:single_process output:directory-------------------"
...
TESTCASE_NO=5
info "------------------- f2s testcase $TESTCASE_NO: format:multi-fast5 input:file process:single_process output:stdout-------------------"
...
TESTCASE_NO=6
info "------------------- f2s testcase $TESTCASE_NO: format:multi-fast5 input:file process:single_process output:directory-------------------"
...
TESTCASE_NO=7
info "------------------- f2s testcase $TESTCASE_NO: format:multi-fast5 input:directory process:single_process output:stdout-------------------"
...
TESTCASE_NO=8
info "------------------- f2s testcase $TESTCASE_NO: format:multi-fast5 input:directory process:single_process output:directory-------------------"
...
TESTCASE_NO=9
info "------------------- f2s testcase $TESTCASE_NO: format:single_and_multi-fast5 input:file process:single_process output:stdout-------------------"
...
TESTCASE_NO=10
info "------------------- f2s testcase $TESTCASE_NO: format:single_and_multi-fast5 input:directory process:single_process output:directory-------------------"
...
rm $OUTPUT_DIR/single-fast5-output/*
TESTCASE_NO=11
info "------------------- f2s testcase $TESTCASE_NO: format:single-fast5 input:file process:multi output:directory-------------------"
...
rm $OUTPUT_DIR/single-fast5-output/*
TESTCASE_NO=12
info "------------------- f2s testcase $TESTCASE_NO: format:single-fast5 input:directory process:multi output:directory-------------------"
...
rm $OUTPUT_DIR/multi-fast5/*
TESTCASE_NO=13
info "------------------- f2s testcase $TESTCASE_NO: format:multi-fast5 input:file process:multi output:directory-------------------"
...
rm $OUTPUT_DIR/multi-fast5/*
TESTCASE_NO=14
info "------------------- f2s testcase $TESTCASE_NO: format:multi-fast5 input:directory process:multi output:directory-------------------"
...
TESTCASE_NO=15
info "------------------- f2s testcase $TESTCASE_NO: format:single_and_multi-fast5 input:directory process:multi output:directory-------------------"
...
#----------------------------------------- run id conflicts -------------------------------------------
TESTCASE_NO=16
info "------------------- f2s testcase $TESTCASE_NO: format:single-fast5 input:directory process:single_process output:stdout run_id_conflicts-------------------"
...
rm $OUTPUT_DIR/single-fast5-output/*
TESTCASE_NO=17
info "------------------- f2s testcase $TESTCASE_NO: format:single-fast5 input:directory process:single_process output:directory run_id_conflicts-------------------"
...
TESTCASE_NO=18
info "------------------- f2s testcase $TESTCASE_NO: format:multi-fast5 input:directory process:single_process output:stdout run_id_conflicts-------------------"
...
TESTCASE_NO=19
info "------------------- f2s testcase $TESTCASE_NO: format:single_and_multi-fast5 input:directory process:single_process output:stdout run_id_conflicts-------------------"
...
TESTCASE_NO=20
info "------------------- f2s testcase $TESTCASE_NO: format:single_and_multi-fast5 input:directory process:single_process output:directory run_id_conflicts-------------------"
...
TESTCASE_NO=21
info "------------------- f2s testcase $TESTCASE_NO: format:single-fast5 input:directory process:single_process output:stdout run_id_conflicts allowed-------------------"
...
rm $OUTPUT_DIR/single-fast5-output/*
TESTCASE_NO=22
info "------------------- f2s testcase $TESTCASE_NO: format:single-fast5 input:directory process:single_process output:directory run_id_conflicts allowed-------------------"
...
TESTCASE_NO=23
info "------------------- f2s testcase $TESTCASE_NO: format:multi-fast5 input:directory process:single_process output:stdout run_id_conflicts allowed-------------------"
...
TESTCASE_NO=24
info "------------------- f2s testcase $TESTCASE_NO: format:single_and_multi-fast5 input:directory process:single_process output:stdout run_id_conflicts allowed-------------------"
...
TESTCASE_NO=25
info "------------------- f2s testcase $TESTCASE_NO: format:single_and_multi-fast5 input:directory process:single_process output:directory run_id_conflicts allowed-------------------"
...
TESTCASE_NO=26
info "------------------- f2s testcase $TESTCASE_NO >>> current directory:fast5 file directory output: stdout-------------------"
...
TESTCASE_NO=27
info "------------------- f2s testcase $TESTCASE_NO >>> auxiliary field missing fast5-------------------"
...
TESTCASE_NO=28
info "------------------- f2s testcase $TESTCASE_NO >>> primary field missing fast5-------------------"
mkdir -p $OUTPUT_DIR/unusual_fast5 || die "creating $OUTPUT_DIR/unusual_fast5 failed"
...
TESTCASE_NO=29
info "------------------- f2s testcase $TESTCASE_NO >>> run_id_missing_in_first_read_group_tracking_id fast5-------------------"
mkdir -p $OUTPUT_DIR/unusual_fast5 || die "creating $OUTPUT_DIR/unusual_fast5 failed"
...
TESTCASE_NO=30
info "------------------- f2s testcase $TESTCASE_NO >>> run_id_missing_in_first_read_group_read but is in the tracking_id group fast5-------------------"
mkdir -p $OUTPUT_DIR/unusual_fast5 || die "creating $OUTPUT_DIR/unusual_fast5 failed"
...
TESTCASE_NO=31
info "------------------- f2s testcase $TESTCASE_NO >>> run_id_missing_in_fifth_read_group_read but is in the tracking_id group fast5-------------------"
mkdir -p $OUTPUT_DIR/unusual_fast5 || die "creating $OUTPUT_DIR/unusual_fast5 failed"
...
TESTCASE_NO=32
info "------------------- f2s testcase $TESTCASE_NO >>> run_id_missing_in_first_read_group_in_both_read_and_tracking_id fast5-------------------"
mkdir -p $OUTPUT_DIR/unusual_fast5 || die "creating $OUTPUT_DIR/unusual_fast5 failed"
...
TESTCASE_NO=33
info "------------------- f2s testcase $TESTCASE_NO >>> run_id_missing_in_fifth_read_group_in_both_read_and_tracking_id fast5-------------------"
mkdir -p $OUTPUT_DIR/unusual_fast5 || die "creating $OUTPUT_DIR/unusual_fast5 failed"
...
TESTCASE_NO=34
info "------------------- f2s testcase $TESTCASE_NO >>> end_reason fast5-------------------"
...
#TESTCASE_NO=35
#info "------------------- f2s testcase $TESTCASE_NO >>> end_reason found only in the second read group fast5 1-------------------"
#mkdir -p $OUTPUT_DIR/end_reason_fast5 || die "creating $OUTPUT_DIR/end_reason_fast5 failed"
...
TESTCASE_NO=35
info "------------------- f2s testcase $TESTCASE_NO >>> end_reason found only in the first read group fast5 2-------------------"
mkdir -p $OUTPUT_DIR/end_reason_fast5 || die "creating $OUTPUT_DIR/end_reason_fast5 failed"
...
TESTCASE_NO=40
info "------------------- f2s testcase $TESTCASE_NO >>> blow5 zlib output using -o -------------------"
...
TESTCASE_NO=41
info "------------------- f2s testcase $TESTCASE_NO >>> blow5 zlib-svb output using -o -------------------"
...
TESTCASE_NO=42
info "------------------- f2s testcase $TESTCASE_NO >>> slow5 output using -o -------------------"
...
TESTCASE_NO=43
info "------------------- f2s testcase $TESTCASE_NO >>> blow5 zlib-svb output to stdout-------------------"
...
TESTCASE_NO=44
info "------------------- f2s testcase $TESTCASE_NO >>> slow5 output to stdout-------------------"
...
TESTCASE_NO=51
info "------------------- f2s testcase $TESTCASE_NO >>> current directory:fast5 file directory output: directory-------------------"
cd $FAST5_DIR/single-fast5
CD_BACK=../../../../..
...
TESTCASE_NO=52
info "------------------- f2s testcase $TESTCASE_NO >>> retain_dir_structure without --retain failure expected -------------------"
$SLOW5_EXEC f2s $FAST5_DIR/retain_dir_structure -d $OUTPUT_DIR/retain_dir_structure && die "testcase $TESTCASE_NO failed"
info "testcase $TESTCASE_NO passed"

TESTCASE_NO=53
info "------------------- f2s testcase $TESTCASE_NO >>> retain_dir_structure-------------------"
...
TESTCASE_NO=54
info "------------------- f2s testcase $TESTCASE_NO >>> end_reason datatype is uint8_t-------------------"
mkdir -p $OUTPUT_DIR/end_reason_fast5 || die "creating $OUTPUT_DIR/end_reason_fast5 failed"
